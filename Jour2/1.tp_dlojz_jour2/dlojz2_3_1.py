...
def train():                                                                                                  
    ...
    parser.add_argument('--metric-step', default=100, type =int,                                         
                        help='Compute and print the metrics every N steps')
    parser.add_argument('--find-unused-parameters', default=False, action='store_true',
                        help='find_unused_parametars arg for ddp')
    ...
    # define metrics
    train_metric = {}
    train_metric['loss'] = MeanMetric().to(gpu) 
    train_metric['acc'] = MulticlassAccuracy(num_classes=1000, average='micro').to(gpu) 
    val_metric = {}
    val_metric['loss'] = MeanMetric().to(gpu)  
